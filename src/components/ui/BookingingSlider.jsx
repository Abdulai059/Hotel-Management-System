  ...
  return (
    <>
      <button
        ...
        className="fixed top-24 right-6 z-50 flex items-center justify-center gap-2 rounded-full bg-[#9dc43b] px-4 py-4 text-sm font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:bg-[#8ab534] focus:ring-2 focus:ring-[#9dc43b]/40 focus:outline-none"
      >
