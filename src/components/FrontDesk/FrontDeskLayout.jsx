        ...
        <div className="flex h-screen bg-gray-50">
            <aside className="w-16 md:w-64 bg-white border-r border-gray-200 flex flex-col">
                <div className="h-20 flex items-center justify-center border-b">
                    <span className="font-bold text-indigo-500">HMS</span>
                </div>
          ...
          ${isActive
                ...
                <button
                    ...
                    className="mt-auto mb-12 mx-auto rounded-indigo-500 bg-indigo-500 hover:bg-indigo-600 text-white rounded-sm"
                >
            ...
            <div className="flex flex-col flex-1">
                <header className="h-14 bg-white border-b border-gray-200 flex items-center justify-between px-6">
                    <span className="font-semibold text-green-900"> Welcome to Front Desk Admin Panel</span>
                    <button className="text-sm px-4 py-1 rounded-full border hover:bg-gray-100">
                        Logout
                    </button>
                </header>
